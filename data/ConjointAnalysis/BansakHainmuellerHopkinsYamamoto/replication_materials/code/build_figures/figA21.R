...
for (k in 1:length(filler)){
  ...
  form1 <- as.formula(paste(fn,"~","cage*chealthcare+cage*cmarriage+cage*cparty+",
                            "chealthcare*cmarriage+chealthcare*cparty+",
                            "cmarriage*cparty"))
...
pdf("../../results/figures/figA21.pdf",width=10,height=8)
p
dev.off()

...
filler <- c("cmaritalm","cvacationm","crelativem","chighwaym","cschoolm")

# reduce to partisans and exclude second stage runs without any fillers
...
pdf("../../results/figures/figA18.pdf",width=10,height=12)
m
dev.off()
